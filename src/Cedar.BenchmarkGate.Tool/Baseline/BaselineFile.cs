...
namespace Cedar.BenchmarkGate.Tool.Baseline;

/// <summary>
/// Thrown when a baseline file is malformed or unreadable. Kept separate
/// from <c>Cedar.BenchmarkGate.BenchmarkDotNet.Parsing.BenchmarkResultParseException</c>
        ...
        if (dto.SchemaVersion != SupportedSchemaVersion)
            throw new BaselineFileException(
                ...
                string.Create(System.Globalization.CultureInfo.InvariantCulture,
                    ...
                    $"This build of Cedar.BenchmarkGate supports schemaVersion {SupportedSchemaVersion}."));
