...
using Cedar.BenchmarkGate.Tool.Commands;
...
var rootCommand = new RootCommand("Cedar.BenchmarkGate — a local-first performance regression gate for BenchmarkDotNet.")
{
    checkCommand,
    captureCommand,
};
